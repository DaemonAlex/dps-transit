...
if IsDuplicityVersion() then
    ...
    function Bridge.RemoveMoney(source, account, amount)
        ...
        return Player.Functions.RemoveMoney(account, amount, 'transit-ticket')
    end
    ...
    function Bridge.AddMoney(source, account, amount)
        local Player = QBCore.Functions.GetPlayer(source)
        if not Player then return false end
        return Player.Functions.AddMoney(account, amount, 'transit-refund')
    end
