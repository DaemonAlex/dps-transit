...
function GetParentResourceName() {
    // A top-level `function GetParentResourceName` IS window.GetParentResourceName,
    // so the old guard called itself forever -> RangeError: Maximum call stack size
    // exceeded, spammed continuously in the client console.
    return 'dps-transit';
}
